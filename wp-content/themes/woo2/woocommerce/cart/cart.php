...
<div class="container-fluid bg-secondary mb-5">
	<div class="d-flex flex-column align-items-center justify-content-center inner-first">
...
<div class="container-fluid pt-5">
	<div class="row px-xl-5">
		<div class="col-lg-8 ">
			<form class="woocommerce-cart-form table-responsive mb-5" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">
				<?php do_action('woocommerce_before_cart_table'); ?>

				<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents table table-bordered text-center mb-0" cellspacing="0">
					...
					<tbody class="align-middle">
						...
						?>
								<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr(apply_filters('woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key)); ?>">
									...
									<td class="product-name align-middle text-left" data-title="<?php esc_attr_e('Product', 'woocommerce'); ?>">
										<?php
						...
						<tr>
							<td colspan="6" class="actions align-middle">
		...
		<div class="col-lg-4">
			...
			<div class="cart-collaterals card border-secondary mb-5">
				<?php
				/**
